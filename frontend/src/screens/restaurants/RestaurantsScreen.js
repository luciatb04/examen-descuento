  ...
  const renderRestaurant = ({ item }) => {
    return (
      ...
      >
        ...
        <TextSemiBold> ({item.porcentajeDescuento} of discounting using the code {item.descuento})<TextSemiBold textStyle={{ color: GlobalStyles.brandPrimary }}></TextSemiBold></TextSemiBold>
